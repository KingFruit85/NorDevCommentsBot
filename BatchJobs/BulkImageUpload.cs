...
//     Helpers helpers)
// {
//     private async Task UploadAllImagesFromCommentsWithImageUrls(DiscordSocketClient client, ulong guildId)
//     {
//         try
//         {
//             logger.LogInformation("Fetching all comments with images.");
//             var response = await apiService.GetAllComments(guildId);
//             if (response != null)
//             {
...
//     }
//
//     public void BuckUploadInBackground(DiscordSocketClient client, ulong guildId)
//     {
//         Task.Run(async () =>
//         {
//             try
//             {
//                 await UploadAllImagesFromCommentsWithImageUrls(client, guildId);
//             }
//             catch (Exception e)
//             {
